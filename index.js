...
export default defineConfig([
	{
		...
		rules: {
			...
			'n/prefer-process-get-builtin-module': 0,
			'n/hashbang': 1,
			...
			'jsdoc/prefer-import-tag': 2,
			'jsdoc/reject-any-type': 0,
			'jsdoc/reject-function-type': 0,
			'jsdoc/require-next-description': 0,
			'jsdoc/require-next-type': 0,
			'jsdoc/require-rejects': 0,
			'jsdoc/require-tags': 0,
			'jsdoc/require-template-description': 0,
			'jsdoc/require-throws-description': 0,
			'jsdoc/require-throws-type': 0,
			'jsdoc/require-yields-description': 0,
			'jsdoc/require-yields-type': 0,
			'jsdoc/ts-method-signature-style': 0,
			'jsdoc/ts-no-empty-object-type': 0,
			'jsdoc/ts-no-unnecessary-template-expression': 0,
			'jsdoc/ts-prefer-function-type': 0,
			'jsdoc/type-formatting': 0,
			...
			'unicorn/consistent-compound-words': 1,
			'unicorn/consistent-date-clone': 1,
			'unicorn/consistent-json-file-read': 1,
			'unicorn/consistent-template-literal-escape': 1,
			'unicorn/isolated-functions': 0,
			'unicorn/no-accessor-recursion': 0,
			'unicorn/no-array-fill-with-reference-type': 1,
			'unicorn/no-array-from-fill': 1,
			'unicorn/no-array-reverse': 0,
			'unicorn/no-array-sort': 0,
			'unicorn/no-blob-to-file': 1,
			'unicorn/no-confusing-array-splice': 0,
			'unicorn/no-duplicate-set-values': 0,
			...
			'unicorn/prefer-get-or-insert-computed': 0,
			'unicorn/prefer-https': 0,
			'unicorn/prefer-import-meta-properties': 1,
			'unicorn/prefer-includes-over-repeated-comparisons': 1,
			'unicorn/prefer-iterator-concat': 0,
			'unicorn/prefer-iterator-to-array-at-end': 0,
			'unicorn/prefer-math-abs': 1,
			'unicorn/prefer-queue-microtask': 0,
			'unicorn/prefer-response-static-json': 1,
			'unicorn/prefer-simple-condition-first': 1,
			'unicorn/prefer-single-call': 1,
			'unicorn/prefer-split-limit': 0,
			'unicorn/prefer-string-match-all': 1,
			'unicorn/prefer-string-pad-start-end': 1,
			'unicorn/prefer-string-repeat': 1,
			'unicorn/require-module-attributes': 2,
			'unicorn/require-module-specifiers': 1,
			'unicorn/switch-case-break-position': 1,
			'unicorn/try-complexity': 1
		}
	},
	{
		files: ['**/*.cjs'],
